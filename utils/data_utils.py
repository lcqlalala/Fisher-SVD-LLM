...
def get_calib_train_data(name, tokenizer, nsamples, seqlen=2048, seed=3, batch_size=1, dataset_cache_dir=None):
    ...
    if name == "c4":
        ...
        traindata = load_dataset('/data1/lichangqun/Dobi-SVD/data_cache/wikitext2', 'default', split='train', cache_dir=dataset_cache_dir)
        tot_text = "\n\n".join(traindata["text"])
    else:
...
def get_wikitext2(nsamples, seed, seqlen, tokenizer, dataset_cache_dir=None):
    ...
    traindata = load_dataset('/data1/lichangqun/Dobi-SVD/data_cache/wikitext2', 'default', split='train', cache_dir=dataset_cache_dir)
    testdata = load_dataset('/data1/lichangqun/Dobi-SVD/data_cache/wikitext2', 'default', split='test', cache_dir=dataset_cache_dir)
...
def get_test_data(name, tokenizer, seq_len=2048, batch_size = 4):
    ...
    if 'wikitext2' in name:
        ...
        test_data = load_dataset('/data1/lichangqun/Dobi-SVD/data_cache/wikitext2', 'default', split='test',)
